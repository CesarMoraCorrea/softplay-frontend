...
import { Calendar, Clock, DollarSign, ArrowLeft, Tag, CheckCircle, AlertCircle } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex justify-between items-start">
                ...
                <div className={`px-4 py-2 rounded-full flex items-center gap-2 ${getStatusColor(reserva.estado)}`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-800 dark:text-white">Información de la Reserva</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">{reserva.horas} {reserva.horas === 1 ? 'hora' : 'horas'}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {reserva.cancha && (
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-gray-800 dark:text-white">Información de la Cancha</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {reserva.cancha.tipoCancha && (
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400">{reserva.cancha.tipoCancha}</p>
                        </div>
                      </div>
                    )}
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">${reserva.total.toLocaleString('es-AR')}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-medium text-green-800 dark:text-green-300">Pago Confirmado</h4>
                    </div>
                    <div className="space-y-1 text-sm text-green-700 dark:text-green-400">
                      <p><strong>ID de Transacción:</strong> {reserva.transactionId}</p>
                      {reserva.paymentMethod && (
                        <p><strong>Método de Pago:</strong> {reserva.paymentMethod}</p>
                      )}
                      {reserva.paymentDate && (
                        <p><strong>Fecha de Pago:</strong> {new Date(reserva.paymentDate).toLocaleDateString('es-ES')}</p>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-8 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300">Reserva no encontrada</h3>
