...
import { Users, FileText, Activity, Settings, Plus, ArrowLeft, Search, Edit, UserPlus, X } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
          <button
            ...
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === 'usuarios' ? 'border-b-2 border-primary text-primary' : 'text-gray-600 dark:text-gray-400'}`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === 'reportes' ? 'border-b-2 border-primary text-primary' : 'text-gray-600 dark:text-gray-400'}`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === 'auditoria' ? 'border-b-2 border-primary text-primary' : 'text-gray-600 dark:text-gray-400'}`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 flex items-center gap-2 ${activeTab === 'configuracion' ? 'border-b-2 border-primary text-primary' : 'text-gray-600 dark:text-gray-400'}`}
          >
                      ...
                      <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                            ...
                            user.role === 'propietario' ? 'bg-blue-100 text-blue-800' :
        ...
        {activeTab === 'reportes' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Genera informes y estadísticas sobre el uso de la plataforma.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <Button className="mt-3 w-full" size="sm">Ver Detalles</Button>
              </div>
        ...
        {activeTab === 'auditoria' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Registro de actividades y cambios en el sistema.</p>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">2023-09-15 14:30</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">Juan Losada</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Creación de usuario</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Se creó el usuario 'ana@example.com'</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">2023-09-14 10:15</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">Juan Losada</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Modificación de cancha</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Se actualizó la cancha 'Camp Nou Sur'</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">2023-09-13 16:45</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">Sistema</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Backup automático</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">Backup completo de la base de datos</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {activeTab === 'configuracion' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Ajusta los parámetros y preferencias del sistema.</p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nombre del Sitio</label>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tiempo Mínimo de Antelación (horas)</label>
                    <Input type="number" defaultValue="2" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tiempo Máximo de Antelación (días)</label>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Comisión por Reserva (%)</label>
