...
import { Calendar, Clock, DollarSign, MapPin, Tag, CheckCircle, AlertCircle, CreditCard, ArrowLeft } from "lucide-react";
...
export default function NuevaReserva() {
  ...
  const crearReserva = async () => {
    ...
    try {
      const { payload } = await dispatch(crearReservaThunk({ 
        canchaId: id, 
        fecha, 
        horas: Number(horas) 
      }));
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Cargando información de la cancha...</p>
            </div>
          </div>
        </div>
      </MainLayout>
      ...
      <MainLayout>
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">Error al cargar</h3>
    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <Link 
            to="/canchas" 
            className="inline-flex items-center gap-2 text-primary hover:text-blue-700 transition-colors mb-4"
          >
            <ArrowLeft className="w-4 h-4" />
            Volver a Canchas
          </Link>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            {paymentCompleted ? "Reserva Completada" : "Nueva Reserva"}
          </h1>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-medium">${cancha?.precioHora?.toLocaleString('es-AR') || 0}</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="p-6 space-y-4">
                        ...
                        <div className="border border-gray-200 dark:border-gray-600 rounded-lg">
                          <div className="p-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                              Reserva tu cancha ahora y paga más tarde. Tu reserva quedará pendiente hasta completar el pago.
                            </p>
                            <Button 
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className={`${paymentMethod === "later" ? "text-yellow-600" : "text-green-600"}`}>
                            {paymentMethod === "later" ? "Pendiente de Pago" : "Pagada"}
                          </p>
                        </div>
                        <div>
                          <p className="font-medium text-gray-700 dark:text-gray-300">ID de Reserva:</p>
